...
| KILN-REQ-002 | KILN shall remain product-neutral and shall not require enterprise-only dependencies. | KILN-NEED-002 | Public adoption requires the core contract to stand outside LATTICE, FLETCHER, BAKER incubation records, or enterprise connectors. | must | KILN | inspection / review | accepted |
